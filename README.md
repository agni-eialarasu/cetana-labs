...
> 🗃️ *This table is generated from the relational data layer (`data/portfolio.json` + `data/users.json`) by `scripts/generate_registry.py` — see [`RFC-LAB-000-002`](docs/rfc/RFC-LAB-000-002-relational-data-model.md). Do not edit it by hand; edit `data/` and regenerate.*
