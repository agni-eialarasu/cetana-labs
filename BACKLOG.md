...
| `TSK-033` | BK-008 Phase 1 — PocketBase stand-up scaffolding: collections schema (`pb_schema.json`), seed importer (`pb_import.py`), devcontainer service | P1 | Eialarasu | 🚧 In Progress | 2026-11-05 |
